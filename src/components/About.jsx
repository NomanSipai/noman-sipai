  ...
  return (
    <div>
      ...
      <div className="w-3/4 mt-7 me-auto ms-auto text-center text-xl">
        <p className="mb-2">
          My name is Emre. I am a <strong>Frontend Developer.</strong> I love
          creating beautifull, usefull websites. I am always open to learn new
        </p>
        <p className="mb-2">
        ...
        <ul className=" font-mono text-lg">
          ...
          <li className="mb-3">Styled Components</li>
          <li className="mb-3">Material UI</li>
          <li className="mb-3">Python</li>
          <li className="mb-3">Firebase</li>
          <li className="mb-3">Postman</li>
          <li className="mb-3">Jira</li>
